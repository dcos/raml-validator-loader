...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RAMLUtil = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HighOrderComposers = __webpack_require__(8);
	...
	var FACET_FRAGMENT_GENERATORS = {
	  ...
	  enum: function _enum(values, context) {
	    ...
	    if (context.options.caseInsensitiveEnums) {
	      ...
	      return _FragmentFactory2.default.testAndPushError(_ENUM + '.indexOf(value.toLowerCase()) === -1', ERROR_MESSAGE, { values: _ENUM_STRING });
	    }
